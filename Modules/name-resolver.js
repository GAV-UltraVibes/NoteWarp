// NameResolver v3.5 — увеличен вес популярности отчеств
...
const NameResolver = {
  ...
  syntax: "Формат входных данных: фамилия имя отчество [м/ж]\nФамилия пишется полностью, модуль попытается определить по ней пол. Если фамилия несклоняемая, пол можно указать явно в конце строки. \nДля имени и отчества достаточно нескольких букв, допустимы пропуски, но не перестановки: \nалр алдр акср -> Александр\nПоставьте курсор на строку с сокращениями и нажмите кнопку",
...
var maleNames = [
  ...
  "Игнат:1", "Эдуард:1", "Аркадий:1", "Пётр:75", "Семён:48", "Георгий:50", "Леонид:40", "Вадим:35",
  "Захар:20", "Григорий:30", "Тарас:5", "Прохор:3", "Гордей:2"
];
...
var femaleNames = [
  ...
  "Дарья:5", "Алина:4", "Вероника:3", "Евгения:5", "Маргарита:5",
  "Валерия:35", "Варвара:60", "Арина:55", "Марина:50", "Инна:35", "Жанна:30",
  "Эльвира:15", "Любовь:45", "Виталина:10", "Стелла:5"
];
...
var patronymicList = [
  ...
  "георгиев:50", "игорев:42", "кириллов:40", "леонидов:40", "максимов:36",
  "романов:34", "степанов:32", "тимофеев:30", "юрьев:28", "захаров:20",
  "матвеев:24", "арсеньев:22", "викторов:20", "владиславов:18", "вячеславов:17",
  "даниилов:16", "денисов:15", "евгеньев:14", "егоров:13", "валерьев:11",
  "вадимов:35", "витальев:9", "константинов:8", "львов:7", "русланов:6",
  "тимуров:5", "ярославов:4", "адамов:3", "альбертов:2.5", "амиров:2",
  "всеволодов:1.5", "гавриилов:1", "герасимов:0.8", "германов:0.5", "гордеев:2",
  "дамиров:0.3", "демидов:0.2", "демьянов:0.15", "иосифов:0.1", "казимиров:0.08",
  "платонов:0.06", "прохоров:3", "родионов:0.03", "святославов:0.02", "тихонов:0.015",
